...
interface RequestCurrencyApi {
    ...
    fun getCurrency(@Header("Authorization") authHeader: String, @Body branchCode: BranchCode) : Call<CurrencyResponse>

    @POST("api/servicelist")
    fun getService(@Header("Authorization") authHeader: String, @Body branchCode: BranchCode) : Call<CurrencyResponse>
}